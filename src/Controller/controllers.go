...
/*
When a Pad is deleted then also delete it's history from the database
*/
...
/*
Updates the start session with of a specific Pad.
Adds in database the time,the ip of the user and the state of the pad (default:1)
*/
